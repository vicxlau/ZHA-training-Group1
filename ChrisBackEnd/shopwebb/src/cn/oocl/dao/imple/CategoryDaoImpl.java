...
//		return super.executeUpdate(sql, param);
		return super.executeUpdate2("call UI_CATEGORY_SAVE(?,?)",
...
//		// 统一调用父类的操作数据的方法
//		return super.executeUpdate(sql, param);
		return super.executeUpdate2("call UI_CATEGORY_UPDATE(?,?,?)",
...
//		return super.executeUpdate(sql, param);
		return super.executeUpdate2("call UI_CATEGORY_DELETE(?)", id);
	}
