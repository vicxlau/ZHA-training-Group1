...
<!--                         <a href="#">Add Product</a> -->
    ...
    <div class="container">
        <div class="row">		
            ...
            <div class="col-md-9">      	
            	 <form action="/shopwebb/CategoryServlet" method='post'>
				 ...
				 <c:if test="${not empty requestScope.categoryList}">	
					...
					<tbody> 
						...
						<tr>
							...
							<td><a href="/shopwebb/CategoryServlet?status=getById&id=${category.id}">Update</a></td>
							<td><a href="/shopwebb/CategoryServlet?status=delete&id=${category.id}">Delete</a></td> 
						</tr>	
						</c:forEach>
