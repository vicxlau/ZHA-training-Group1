...
12. URL is using absolute path
13. external or internal web app. if internal: extjs/easyui + spring mvc + jpa + spring. external: html+css+js+jquery + spring mvc + spring + jpa
