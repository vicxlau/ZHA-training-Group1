				...
				<div class="cart-header">
					<div class="cart-sec">
						<div class="cart-item-info">
							...
							<span>
								<div>
									<span>订单号： ${sessionScope.purchaseCart.id} </span>
								</div>
								<div>
									<span>姓名： ${sessionScope.purchaseCart.name}</span>
								</div>
								<div>
									<span>通讯地址：${sessionScope.purchaseCart.address}</span>
								</div>
								<div>
									<span>通讯电话：${sessionScope.purchaseCart.phone}</span>
								</div>
								<div>
									<span>支付金额：￥${sessionScope.purchaseCart.total}</span>
								</div>
								<div>
									<span>支付方式：
...
<%-- 								<input type="hidden" name="p2_Order" value="${sessionScope.purchaseCart.id}"/>					 --%>
<%-- 								<input type="hidden" name="p3_Amt" value="${sessionScope.purchaseCart.total}"/>					 --%>
