...
<body>
   ...
   <c:if test="${sessionScope.purchaseCart==null}">
   	    <c:redirect url="../home" />
   </c:if>
...
<!-- 			</div> -->
			...
			<div class="cart-items">
				...
				<c:forEach items="${sessionScope.purchaseCart.itemList}" var="item">
					<div class="cart-header">
						<div class="cart-sec">
			...
			<div class="cart-total">
				<div class="price-details">
					<h3>Price Details</h3>
					<span>Total</span> <span class="total">￥${sessionScope.purchaseCart.total}</span>
					<span>Discount</span> <span class="total">---</span> <span>Delivery
						Charges</span> <span class="total">￥0.00</span>
					<div class="clearfix"></div>
				</div>
				<h4 class="last-price">TOTAL</h4>
				<span class="total final">￥${sessionScope.purchaseCart.total}</span>
				<div class="clearfix"></div>
